...
from flask import render_template, request, Blueprint, jsonify, current_app, session, send_from_directory, flash
from sqlalchemy.orm import joinedload
from werkzeug.utils import secure_filename

from Package import db_session, app
from Package.models import Folders, Teachers, UploadedFiles, Workspace
from Package.condition_login import admin_required, login_required
from Package.routes.common.utils import allowed_file, get_file_size, get_file_type, get_workspace_info
from Package import ALLOWED_EXTENSIONS,MAX_FILE_SIZE

bp = Blueprint('admin_files', __name__, url_prefix='/<workspace_id>/admin')
        ...
        for file in files:
            ...
            try:
                ...
                uploaded_file = UploadedFiles(
                    folder_id=folder_id,
                    uploaded_by= current_user_id,  # Assuming you have current_user available
...
@bp.route('/files/delete/<file_id>', methods=['POST'])
@login_required
@admin_required
...
@bp.route('/files/folder/<folder_id>')
@admin_required
@login_required
