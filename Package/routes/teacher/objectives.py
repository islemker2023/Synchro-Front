...
@bp.route('/<workspace_id>/teacher/objectives/<objective_id>/sub-objective/<sub_objective_id>/toggle', methods=['POST'])
@teacher_required
@login_required
...
@bp.route('/<workspace_id>/teacher/objectives/<objective_id>/details')
@teacher_required
@login_required
